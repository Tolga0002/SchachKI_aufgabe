...
-------------------------------------
Bevor der Mini-Max Algorithmus implementiert ist kann man bereits
manuell spielen. Dazu müssen jedoch die wichtigsten Methoden der Board und Pieces-Klassen 
korrekt implementiert sein. Um das Spiel im manuellen Modus zu starten gib folgenden Befehl auf der Konsole aus:
